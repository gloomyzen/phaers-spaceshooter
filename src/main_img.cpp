...
int main(int, char**)
{
...
#if __APPLE__
  // GL 3.2 + GLSL 150
  std::cout << "really APPLE" << std::endl;
  ...
  // GL 3.0 + GLSL 130
    ...
    /**
     * TODO need create definition for GLFW_CONTEXT_VERSION_MAJOR and GLFW_CONTEXT_VERSION_MINOR
     */
  ...
  GLFWwindow* window = glfwCreateWindow(1280, 720, "Test window title", NULL, NULL);
  if (!window) {
    glfwTerminate();
